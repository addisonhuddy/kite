...
set +e
(cd "$TMP/work" && HOME="$TMP/home" XDG_CONFIG_HOME="$TMP/xdg" KITE_SECURITY_PROTOCOL=PLAINTEXT "$BIN" demo >"$TMP/env-over-invalid-file.out" 2>"$TMP/env-over-invalid-file.err")
status=$?
set -e
